...
namespace TerrainPainter
{
    ...
    public class TerrainPainterEditor : Editor
    {
        ...
        private static GUIContent[] m_menuToolbarItems = new GUIContent[] {
        ...
        private GUIContent m_undoIcon = new GUIContent(tp_Editor.IconContent("Undo", "Undo"));
        private GUIContent m_redoIcon = new GUIContent(tp_Editor.IconContent("Redo", "Redo"));
        #endregion
        ...
        private void DrawMenu()
        {
            ...
            //component.EditingTool = (EditingTool)GUILayout.Toolbar((int)component.EditingTool, m_menuToolbarItems, tp_Editor.ToolbarOptions(m_menuToolbarItems.Length));
            ...
            currentSelected = GUILayout.Toolbar(currentSelected, m_menuToolbarItems, tp_Editor.ToolbarOptions(m_menuToolbarItems.Length));
        ...
        private void DrawUndo(GUILayoutOption[] options)
        {
            ...
            if (GUILayout.Button(m_undoIcon, options)) { component.History.Undo(); }
            GUI.enabled = true;
        }
        /// <summary>
        /// Redo button
        ...
        private void DrawRedo(GUILayoutOption[] options)
        {
            ...
            if (GUILayout.Button(m_redoIcon, options)) { component.History.Redo(); }
            GUI.enabled = true;
        }
        #endregion
