Shader "Nature/Terrain/Distingo Standard" 
{
	Properties 
	{
	...
	Dependency "AddPassShader" = "Hidden/TerrainEngine/Splatmap/Distingo Standard-AddPass"
	Dependency "BaseMapShader" = "Hidden/TerrainEngine/Splatmap/Distingo Standard-Base"
