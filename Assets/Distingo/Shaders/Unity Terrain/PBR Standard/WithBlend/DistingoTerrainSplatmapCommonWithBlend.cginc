...
#else
void SplatmapMix(Input IN, out half4 splat_control, out half weight, out fixed4 mixedDiffuse, inout fixed3 mixedNormal, float4 offsetMin, float4 offsetMax, float4 normalMod, float depth)
#endif
{
