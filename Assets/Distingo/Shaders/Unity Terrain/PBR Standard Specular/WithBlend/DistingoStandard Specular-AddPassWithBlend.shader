Shader "Hidden/TerrainEngine/Splatmap/Distingo Standard Specular-AddPassWithBlend" 
{
	Properties 
	{
	...
	SubShader 
	{
		...
		#pragma surface surf StandardSpecular decal:add vertex:SplatmapVert finalcolor:myfinal exclude_path:prepass exclude_path:deferred fullforwardshadows
		...
		void surf(Input IN, inout SurfaceOutputStandardSpecular o)
		{
			...
			o.Specular = dot(splat_control, half4(_Metallic0, _Metallic1, _Metallic2, _Metallic3));
		}
	...
	Fallback "Hidden/TerrainEngine/Splatmap/Distingo Diffuse-AddPassWithBlend"
}
