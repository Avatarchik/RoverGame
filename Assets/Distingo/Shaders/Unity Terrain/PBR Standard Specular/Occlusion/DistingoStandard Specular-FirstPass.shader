Shader "Nature/Terrain/Distingo Standard Specular" 
{
	Properties 
	{
	...
	Dependency "AddPassShader" = "Hidden/TerrainEngine/Splatmap/Distingo Standard Specular-AddPass"
	Dependency "BaseMapShader" = "Hidden/TerrainEngine/Splatmap/Distingo Standard Specular-Base"
